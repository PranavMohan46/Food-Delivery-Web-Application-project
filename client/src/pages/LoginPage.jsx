        ...
        <div className="auth-side">
          <div className="hero-panel dark">
            <div className="hero-panel-inner">
              ...
              <h1 className="page-headline" style={{ fontWeight: 900, letterSpacing: "-0.02em" }}>
                Your next meal is <span style={{ color: "#ffd9b3" }}>already nearby.</span>
              </h1>
              <p className="auth-copy" style={{ fontSize: "1.1rem", opacity: 0.9 }}>
